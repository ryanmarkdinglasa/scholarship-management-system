...
?>
  ...
  <!-- Topnav -->
<div class="fixed-top ">
  <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom " style="height:50px;">
        ...
        <ul class="navbar-nav align-items-center ml-md-auto">
          <li class="nav-item dropdown">
            <p class="nav-link mb-0 text-sm  font-weight-bold text-white" href="#">
              ...
              $year_period = date('n');
              if ($year_period <= 6) {
                $year_period = intval($year - 1) . "/" . $year .  " " . " 1st Semester";
                echo $year_period;
              } else {
                $year_period = $year . "/" . intval($year + 1). " ". " 2nd Semester";
                echo $year_period;
              } ?>
            </p>
          </li>
          <li class="nav-item dropdown pe-2 d-flex align-items-center">
			  ...
			  <?php
				$noti =count_notification('notification',$user['user_id']);
					if($noti>0){
