      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link <?php echo ($page == "Scholarship" ? "active" : "") ?>" href="scholarship_program.php">
                <i class="ni ni-hat-3  text-primary"></i>
                <span class="nav-link-text">Scholarship Program</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link <?php echo ($parentpage == "Account" ? "active" : "") ?>" href="#navbar-dataakun" data-toggle="collapse" role="button" aria-expanded="<?php echo ($parentpage == "account" ? "true" : "false") ?>" aria-controls="navbar-dataaccount">
              ...
              <div class="collapse <?php echo ($parentpage == "Account" ? "show" : "") ?>" id="navbar-dataakun">
                <ul class="nav nav-sm flex-column">
                  <li class="nav-item">
                    <a href="scholarship_provider.php" class="nav-link <?php echo ($childpage == "scholarship_provider" ? "active" : "") ?>">Scholarship Provider</a>
                  </li>
                  <li class="nav-item">
                    <a href="student.php" class="nav-link <?php echo ($childpage == "student" ? "active" : "") ?>">Student</a>
                  </li>
                  <li class="nav-item">
                    <a href="admin.php" class="nav-link  <?php echo ($childpage == "admin" ? "active" : "") ?>">Admin</a>
                  </li>
			...
			<li class="nav-item">
              <a class="nav-link <?php echo ($page == "feedback" ? "active" : "") ?>" href="feedback.php">
            ...
            <li class="nav-item">
              <a class="nav-link <?php echo ($page == "userlog" ? "active" : "") ?>" href="userlog.php">
                ...
                <span class="nav-link-text">User Login History</span>
              </a>
            </li>
          </ul>
          <!-- Divider -->
