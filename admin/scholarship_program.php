                          ...
                          <div class="card bg-secondary border-0 mb-0">
                            <div class="card-body px-lg-5 py-lg-5">
                              <div class="text-center text-muted mb-4">
                                <small>Add New Scholarhsip Program</small>
                              </div>
                              <form role="form" method="post" action="scholarship_program_controller.php">
                              <div class="form-group mb-3">
                                  	...
                                  	<div class="input-group input-group-merge input-group-alternative">
										...
										<input id="sp_name" name="sp_name" class="form-control" placeholder="Enter Scholarship Program Name" type="text" title="Enter Scholarship Program Name"  oninvalid="this.setCustomValidity('Please enter the new Scholarship Program Name.')" oninput="setCustomValidity('')" required>
                                	</div>
                                ...
                                <div class="form-group mb-3">
									...
									<div class="input-group input-group-merge input-group-alternative">
										...
										<input class="form-control" id="sp_description" name="sp_description" placeholder="Enter Description" type="text" title="Enter Description"  oninvalid="this.setCustomValidity('Please enter a new Description.')" oninput="setCustomValidity('')" required>
									</div>
                                </div>
							...
							<td class="text-right">
							  <div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow"> 
									<a class="dropdown-item" data-id="<?php echo $row['id'] ?>" style="color: black;" type="button" data-toggle="modal" data-target="#modal-edit-form<?php echo $row['id']; ?>"><i class="fas fa-pen" style="color:#172b4d;" ></i> Edit Scholarship Program</a>
								  <a class="dropdown-item" href="scholarship_program_controller.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to clear the scholarship program, <?php echo htmlentities($row['name']);?> ?')"><i class="fas fa-trash" style="color:#f5365c;"></i> Delete Scholarship Program</a>	
								</div>
							  </div>
							</td>
						  </tr>
							...
							<div class="modal fade" id="modal-edit-form<?php echo $row['id'];?>" tabindex="-1" role="dialog" aria-labelledby="modal-edit-form" aria-hidden="true">
								...
								<div class="modal-content">
									...
									<div class="card bg-secondary border-0 mb-0">
										<div class="card-body px-lg-5 py-lg-5">
										<div class="text-center text-muted mb-4">
											<small>Edit Scholarhsip Program</small>
										</div>
										<form role="form" method="post" action="scholarship_program_controller.php">
										<div class="form-group mb-3">
											<label class="form-control-label">Name</label>
											<div class="input-group input-group-merge input-group-alternative">
												...
												<input id="edit_sp_id" name="edit_sp_id" class="sp_id form-control" value="<?php echo $row['id']?>" placeholder="Enter Scholarship Program Name" type="hidden" title="Enter Scholarship Program Name"  oninvalid="this.setCustomValidity('Please enter the new Scholarship Program Name.')" oninput="setCustomValidity('')" required>
												<input id="edit_sp_name" name="edit_sp_name" class="form-control" value="<?php echo $row['name']?>" placeholder="Enter Scholarship Program Name" type="text" title="Enter Scholarship Program Name"  oninvalid="this.setCustomValidity('Please enter the new Scholarship Program Name.')" oninput="setCustomValidity('')" required>
											</div>
											<span id="user-availability-status1"></span>
											</div>
											<div class="form-group mb-3">
												...
												<div class="input-group input-group-merge input-group-alternative">
													...
													<input class="form-control" id="edit_sp_description" name="edit_sp_description" value='<?php echo $row['description']?>' placeholder="Enter Description" type="text" title="Enter Description"  oninvalid="this.setCustomValidity('Please enter a new Description.')" oninput="setCustomValidity('')" required>
												</div>
											</div>
											<div class="text-center">
