              ...
              <div class="card bg-secondary border-0 mb-0">
                <div class="card-body px-lg-5 py-lg-5">
                  <div class="text-center text-muted mb-4">
                    <small>Add New Administrator</small>
                  </div>
                  <form action="admin_controller.php" role="form" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <small>Password default:</small><small style="color:red;"> auto generated</small>
                    </div>
                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            if ($status > 0) :
                            ?>
                              <a class="dropdown-item" href="admin_controller.php?id=<?php echo $row['id'] ?>&off=0"><i class="fas fa-lock" style="color:#fb6340;"></i> Deactivate Account</a>
                            <?php else : ?>
                              <a class="dropdown-item" href="admin_controller.php?id=<?php echo $row['id'] ?>&on=1"><i class="fas fa-lock-open" style="color:#2dce89;"></i> Activate Account</span></a>
                            <?php endif; ?>

                            <a class="dropdown-item" href="admin_controller.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Are you sure you want to remove admin, <?php echo htmlentities($row['username']); ?> ?')"><i class="fas fa-trash" style="color:#f5365c;"></i> Delete Account</a>
                          </div>
                        </div>
                      </td>
                    </tr>
