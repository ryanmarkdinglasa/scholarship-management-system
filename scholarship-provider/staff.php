            ...
            <div class="modal-body p-0">
              <div class="card bg-secondary border-0 mb-0">
                <div class="card-body px-lg-5 py-lg-5">
                  ...
                  <form action='staff_controller.php' role="form" method="post">
                    ...
                    <label class="form-control-label" >Position</label>
                      <div class="input-group input-group-merge input-group-alternative">
                        ...
                        <div class="input-group-prepend">
                          <span class="input-group-text" data-toggle="tooltip" data-placement="top" title="Please enter a school or university."><i class="fas fa-question-circle"></i></span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="text-center pb-0">
                      <button type="submit" id="add" name="add" class="btn btn-primary my-4">Add User</button>
                    </div>
                  </form>
                </div>
              </div>
                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            if ($status > 0) :
                            ?>
                            <a class="dropdown-item" href="staff_controller.php?id=<?php echo $row['user_id'] ?>&off=0"><i class="fas fa-lock" style="color:#fb6340;"></i> Deactivate Account</a>
                            <?php else : ?>
                              <a class="dropdown-item" href="staff_controller.php?id=<?php echo $row['user_id'] ?>&on=1"><i class="fas fa-lock-open" style="color:#2dce89;"></i>Activate Account</span></a>
                            <?php endif; ?>
                            <a class="dropdown-item" href="staff_edit.php?id=<?php echo $row['user_id'] ?>" style="color: black;" type="button"><i class="fas fa-pen" style="color:#172b4d;"></i> Edit Account</a>
                            <a class="dropdown-item" href="staff_controller.php?id=<?php echo $row['user_id'] ?>&del=delete" onClick="return confirm('Are you sure you want to clear, <?php echo htmlentities($row['user_username']); ?> ?')"><i class="fas fa-trash" style="color:#f5365c;"></i> Delete Account</a>
                          </div>
                        </div>
                      </td>
                    </tr>
