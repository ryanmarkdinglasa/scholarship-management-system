              ...
              <div class="row justify-content-center" >
                <div class="col-lg-3 order-lg-2">
                  <div class="card-profile-image" >
                    ...
                    <?php else : ?>
                      <img src="img/<?php echo $userphoto; ?>" class="rounded-circle" style="border-radius:50%;background:#f1f1f1;">
                    <?php endif; ?>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Edit Scholarship Program  </h3>
                </div>
                      ...
                      <div class="col-lg-6">
                        <div class="form-group">
                          ...
                          <div class="input-group input-group-merge">
							...
							$name = isset($row['name']) ? htmlspecialchars($row['name'], ENT_QUOTES, 'UTF-8') : '';
							?>
                            <input type="text" id="name" name="name" class="form-control" placeholder="First name" value="<?php echo $name; ?>">
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-lg-12">
                        <div class="form-group">
                          ...
                          <div class="input-group input-group-merge">
							...
							$description = isset($row['description']) ? htmlspecialchars($row['description'], ENT_QUOTES, 'UTF-8') : '';
							?>
                            <input type="text" id="description" name="description" class="form-control" placeholder="First name" value="<?php echo $description; ?>">
                          </div>
                        </div>
                      </div>
                    </div>
                            ...
                            <div class="card bg-secondary border-0 mb-0">
                              ...
                              <div class="card-body px-lg-5 py-lg-5">
                                ...
                                <div class="text-center">
                                  <button type="submit" id="update-sp" name="update-sp" class=" update-profile btn btn-primary my-4 ">Change Data</button>
                                </div>
                              </div>
                            </div>
                          </div>
