				...
				<table class="table align-items-center table-flush table-striped" >
					...
					<tbody>
					  ...
					  try{
						...
						WHERE `recepient_id`='".$user['user_id']."'";
						$query = $con->query($sql);
					  }catch(Exception $e){
						...
						<tr>
						  ...
						  <td class="text-right">
							<div class="dropdown">
							  ...
							  <a class="dropdown-item" href="notification_view.php?id=<?php echo $row['n_id'] ?>"><i class="fas fa-eye text-primary"></i> View Notification</a>
								<?php $status = $row['n_status'];
								if ($status > 0) :
								?>
