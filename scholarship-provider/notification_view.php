<?php
  ...
  error_reporting(0);
	...
	$parentpage_link= "notification.php";
	$currentpage='View Notification';
	$page=$childpage = "notification";
	...
	$row=$check_id=getrecord('notification',['id'],[$_GET['id']]);
	if(empty($check_id)){
		header('location:404.php');
		exit();
	}
        ...
        <div class="col">
          ...
          <div class="card">
            ...
            <div class="card-header border-1">
              <div class="row">
                <div class="col-6">
                  <h3 class="mb-0">Notification Information</h3>
                </div>
              </div>
            </div>
			<div class="card-body">
          ...
          <div class="col-12">
            <div class="form-group">
              <p class="text-muted" for="email">
              <label class="form-control-label heading-small">Sender</label><br>
							<?php
							$getemail=getrecord('user',['id'],[$row['sender_id']]);
              ...
              <p class="text-muted">
              <label class="form-control-label heading-small">Details</label><br>
							<?php
							$details = $row['content'];
							echo $row['content'];
							?>
